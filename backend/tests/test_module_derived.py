...
# TestDerivationChainE2E removed — transitive derivation via
# Allows_value_from_category was intentionally removed. Only direct
# category members and subobject properties are now included.


class _RemovedTestDerivationChainE2E:
