...
- [14-07]: Status badge colors: draft (outline), validated (green), submitted (blue), merged (purple), rejected (red)
- [14-07]: Validate button only shown when status is DRAFT, Submit PR only enabled when VALIDATED
