# Requirements Archive: v2.1 Bug Fixes & UX Improvements
...
- [x] **ENTITY-01**: User can view subobject details without "Failed to load" error
- [x] **ENTITY-02**: User can view template details without "Failed to load" error
- [x] **ENTITY-03**: User can view module details without "Failed to load" error
- [x] **ENTITY-04**: User can view bundle details without "Failed to load" error

### Draft Workflow

- [x] **DRAFT-01**: User can click Validate button in draft mode
- [x] **DRAFT-02**: User can click Submit PR button in draft mode
- [x] **DRAFT-03**: Auto-validation triggers when user makes changes to draft
...
- [x] **MGMT-01**: User can create new category via "+ New Category" button in sidebar
- [x] **MGMT-02**: User can create new property via "+ New Property" button in sidebar
- [x] **MGMT-03**: User can create new subobject via "+ New Subobject" button in sidebar
- [x] **MGMT-04**: User can create new template via "+ New Template" button in sidebar
- [x] **MGMT-05**: User can create new module via "+ New Module" button in sidebar
- [x] **MGMT-06**: User can create new bundle via "+ New Bundle" button in sidebar
- [x] **MGMT-07**: User can delete entity in draft mode
- [x] **MGMT-08**: User can add dependencies to existing entity
...
| DRAFT-01 | 16, 21 | Complete |
| DRAFT-02 | 16, 21 | Complete |
...
**Adjusted:**
- DRAFT-01, DRAFT-02: Initially marked complete in Phase 16, but required additional fixes in Phase 21 (status case mismatch, OAuth redirect)
- MGMT-07: Initially implemented in Phase 20, required bug fix in Phase 22 (CREATE->DELETE handling)
