...
3. Update frontend/src/pages/DraftPage.tsx:
   ...
   Add BulkModuleAssignment component above DiffViewer:
   - Import BulkModuleAssignment from '@/components/draft/BulkModuleAssignment'
   - Render <BulkModuleAssignment diff={diff} /> only when diff.categories.added.length > 0
   - Position above the DraftDiffViewer component
