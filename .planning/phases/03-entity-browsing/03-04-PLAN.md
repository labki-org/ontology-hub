...
must_haves:
  truths:
    ...
    - "Module badges are displayed for Phase 4 linking when module pages exist"
  artifacts:
...
Note: This gap closure plan assumes Plans 01-03 are already executed (per ROADMAP). It extends existing files created in those plans.
</objective>
