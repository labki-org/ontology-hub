...
must_haves:
  truths:
    ...
    - "Direct edits and transitive effects are stored as separate Sets for distinct styling"
  artifacts:
...
<objective>
Add change tracking foundation to draftStoreV2 and create dependency graph utility.
...
Output: Extended draftStoreV2 with Sets for tracking edited/affected entities, plus a utility function for computing transitive dependencies via BFS.
</objective>
